...
async function readVerifiedEvents(): Promise<LiveEvent[]> {
  ...
  try {
    ...
    for (const item of source) {
      ...
      // Só entra se existir algum dado efetivamente fornecido pelo servidor.
